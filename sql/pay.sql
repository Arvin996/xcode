...
-- 导出 xk-learn-pay 的数据库结构
CREATE DATABASE IF NOT EXISTS `xk-learn-pay` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `xk-learn-pay`;

-- 导出  表 xk-learn-pay.pay_app 结构
...
-- 正在导出表  xk-learn-pay.pay_app 的数据：~0 rows (大约)

-- 导出  表 xk-learn-pay.pay_app_channel 结构
...
-- 正在导出表  xk-learn-pay.pay_app_channel 的数据：~0 rows (大约)

-- 导出  表 xk-learn-pay.pay_channel 结构
...
-- 正在导出表  xk-learn-pay.pay_channel 的数据：~0 rows (大约)

-- 导出  表 xk-learn-pay.pay_merchant 结构
...
-- 正在导出表  xk-learn-pay.pay_merchant 的数据：~0 rows (大约)

-- 导出  表 xk-learn-pay.pay_notify_log 结构
...
-- 正在导出表  xk-learn-pay.pay_notify_log 的数据：~0 rows (大约)

-- 导出  表 xk-learn-pay.pay_notify_task 结构
...
-- 正在导出表  xk-learn-pay.pay_notify_task 的数据：~0 rows (大约)

-- 导出  表 xk-learn-pay.pay_order 结构
...
-- 正在导出表  xk-learn-pay.pay_order 的数据：~0 rows (大约)

-- 导出  表 xk-learn-pay.pay_refund 结构
...
-- 正在导出表  xk-learn-pay.pay_refund 的数据：~0 rows (大约)
