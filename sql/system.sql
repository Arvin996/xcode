...
-- 导出 xk-learn-system 的数据库结构
CREATE DATABASE IF NOT EXISTS `xk-learn-system` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `xk-learn-system`;

-- 导出  表 xk-learn-system.system_client 结构
...
-- 导出  表 xk-learn-system.system_dict 结构
...
-- 导出  表 xk-learn-system.system_resource 结构
...
-- 导出  表 xk-learn-system.system_role 结构
...
-- 导出  表 xk-learn-system.system_role_resource 结构
...
-- 导出  表 xk-learn-system.system_third_user 结构
...
-- 导出  表 xk-learn-system.system_user 结构
...
-- 导出  表 xk-learn-system.system_user_role 结构
