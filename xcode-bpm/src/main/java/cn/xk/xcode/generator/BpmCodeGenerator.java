 ...
 * @Version 1.0.0
 * @Description BpmCodeGenerator
 **/
public class BpmCodeGenerator implements ICodeGenerator {
    ...
    public CodeGen createCodeGen() {
        return CodeGen.builder()
                ...
                .sourceDir(System.getProperty("user.dir") + "/own_module/xcode-parent/xcode-bpm/src/main/java")
                .tables(new String[]{"flow_oa_leave"})
                .mapperXmlPackage(System.getProperty("user.dir") + "/own_module/xcode-parent/xcode-bpm/src/main/resources/mapper")
    ...
    public static void main(String[] args) {
        ICodeGenerator codeGenerator = new BpmCodeGenerator();
