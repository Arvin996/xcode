...
public class MoneyUtil {
    ...
    public static Integer calculateRatePrice(Integer price, Double rate){
        return calculateRatePrice(price, rate, PRICE_SCALE, RoundingMode.HALF_UP).intValue();
    }
    ...
    public static Integer calculateRatePriceFloor(Integer price, Double rate){
        return calculateRatePrice(price, rate, PRICE_SCALE, RoundingMode.FLOOR).intValue();
    }
    ...
    public static BigDecimal calculateRatePrice(Number price, Number rate, int scale, RoundingMode roundingMode){
        return NumberUtil.toBigDecimal(price).multiply(PERCENT_100).divide(NumberUtil.toBigDecimal(rate), scale, roundingMode);
    }
