...
public class MessageChannelTableDef extends TableDef {
     ...
     * 
     */
    public static final MessageChannelTableDef MESSAGE_CHANNEL_PO = new MessageChannelTableDef();
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{ID, CODE, SUPPORT_LOAD_BALANCE, NAME, STATUS, CREATE_TIME, UPDATE_TIME, CREATE_USER, UPDATE_USER};
