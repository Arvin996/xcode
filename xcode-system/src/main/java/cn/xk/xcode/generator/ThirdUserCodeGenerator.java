 ...
 * @Date 2024/7/8 09:17
 * @Version 1.0
 * @Description ThirdUserCodeGenerator
 */
public class ThirdUserCodeGenerator implements ICodeGenerator
{
    ...
    public CodeGen createCodeGen() {
        return CodeGen.builder()
                ...
                .tablePrefix("system_")
                .tables(new String[]{"system_third_user"})
    ...
    public static void main(String[] args) {
        ThirdUserCodeGenerator wxUserCodeGenerator = new ThirdUserCodeGenerator();
        wxUserCodeGenerator.doGenerate();
    }
}
