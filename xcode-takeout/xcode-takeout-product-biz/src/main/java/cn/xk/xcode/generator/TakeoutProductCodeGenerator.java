...
public class TakeoutProductCodeGenerator implements ICodeGenerator{
    ...
    public CodeGen createCodeGen() {
        return CodeGen.builder()
                ...
                .sourceDir(System.getProperty("user.dir") + "/own_module/xcode-parent/xcode-takeout/xcode-takeout-product-biz/src/main/java")
                .tables(new String[]{"takeout_category", "takeout_dish", "takeout_flavor", "takeout_dish_flavor", "takeout_setmeal", "takeout_setmeal_dish"})
                .mapperXmlPackage(System.getProperty("user.dir") + "/own_module/xcode-parent/xcode-takeout/xcode-takeout-product-biz/src/main/resources/mapper")
