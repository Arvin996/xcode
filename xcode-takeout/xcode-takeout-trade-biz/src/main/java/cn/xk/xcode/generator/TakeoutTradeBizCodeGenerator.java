...
public class TakeoutTradeBizCodeGenerator implements ICodeGenerator{
    ...
    public CodeGen createCodeGen() {
        return CodeGen.builder()
                ...
                .sourceDir(System.getProperty("user.dir") + "/own_module/xcode-parent/xcode-takeout/xcode-takeout-trade-biz/src/main/java")
                .tables(new String[]{"takeout_orders", "takeout_order_detail", "takeout_shopping_cart"})
                .mapperXmlPackage(System.getProperty("user.dir") + "/own_module/xcode-parent/xcode-takeout/xcode-takeout-trade-biz/src/main/resources/mapper")
