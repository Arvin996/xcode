 ...
 * @Version 1.0
 * @Description BaseStringEntityChangeListener
 */
@Slf4j
public class BaseStringEntityChangeListener implements InsertListener, UpdateListener, SetListener {

    @Override
    public void onInsert(Object o) {
        setPropertyIfPresent(o, "createTime", LocalDateTime.now());
        setPropertyIfPresent(o, "createUser", StpUtil.getLoginIdAsString());
    }
    ...
    public void onUpdate(Object o) {
        ...
        setPropertyIfPresent(o, "updateUser", StpUtil.getLoginIdAsString());
    }
