 ...
 * @Version 1.0
 * @Description FileCodeGenerate
 */
public class FileCodeGenerate implements ICodeGenerate{
    ...
    public static void main(String[] args) {
        FileCodeGenerate fileCodeGenerate = new FileCodeGenerate();
        fileCodeGenerate.doGenerate();
    }
}
