 ...
 * @Date 2024/7/8 09:17
 * @Version 1.0
 * @Description WxUserCodeGenerate
 */
public class ThirdUserCodeGenerate implements ICodeGenerate
{
    ...
    public static void main(String[] args) {
        ThirdUserCodeGenerate wxUserCodeGenerate = new ThirdUserCodeGenerate();
        wxUserCodeGenerate.doGenerate();
    }
}
